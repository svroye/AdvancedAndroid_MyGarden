...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int imgRes,
        ...
        // set the image resource on thr widget
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        // DONE (2): Move the updateAppWidget loop to a new method called updatePlantWidgets and
        // pass through the image resource. There may be multiple widgets active, so update all of them
        // DONE (4): Call startActionUpdatePlantWidgets in onUpdate as well as in AddPlantActivity
