...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews rv;
        if (width < 300){
            rv = getSinglePlantRemoteView(context, imgRes, showWater, plantId);
        } else {
    ...
    public static RemoteViews getGardenGridRemoteView(Context context){
        Log.d("PlantWidgetprovider", "Inside getGardenGridRemoteView");
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_grid_view);

        // set GridWidgetService intent to act as the adapter for the GridView
    ...
    public static RemoteViews getSinglePlantRemoteView(Context context, int imgRes, boolean
                                                       showWater, long plantId){
        Intent intent;
